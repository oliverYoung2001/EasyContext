...
from tests import _custom_ops as ops
from tests.distributed.device_communicators.custom_all_reduce_utils import (
    gpu_p2p_access_check)
from tests.distributed.parallel_state import in_the_same_node_as
# from vllm.logger import init_logger
from tests.utils import cuda_device_count_stateless, is_full_nvlink
...
class CustomAllreduce:
    ...
    def register_graph_buffers(self):
        ...
        # logger.info(
        print(f'[WARN]: '
            "Registering %d cuda graph addresses", len(offset))
