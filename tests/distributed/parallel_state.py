...
class GroupCoordinator:
    ...
    def __init__(
        ...
        from tests.distributed.device_communicators.custom_all_reduce import (
            CustomAllreduce)
        from tests.distributed.device_communicators.pynccl import (
            PyNcclCommunicator)
        ...
        from tests.distributed.device_communicators.shm_broadcast import (
            MessageQueue)
...
def in_the_same_node_as(pg: ProcessGroup, source_rank: int = 0) -> List[bool]:
    ...
    try:
        ...
        print(f'[ERROR]: Error ignored in is_in_the_same_node: {e}')
    finally:
        if shm:
            shm.close()
